<button class="btn btn-ghost btn-sm ff-secondary d-flex gap-2 align-items-center dropdown-toggle oe-control-button" data-bs-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
...
<ul class="dropdown-menu p-1 text-sm" role="menu">
	<li>
		<a component="topic/mark-unread-for-all" href="#" class="dropdown-item d-flex align-items-center gap-2" role="menuitem">
			<i class="fa fa-fw fa-inbox text-secondary"></i> [[topic:thread-tools.markAsUnreadForAll]]
		</a>
	</li>
	<li>
		<a component="topic/pin" href="#" class="dropdown-item d-flex align-items-center gap-2" role="menuitem">
	...
	<li>
		<a component="topic/lock" href="#" class="dropdown-item d-flex align-items-center gap-2" role="menuitem">
			<i class="fa fa-fw fa-lock text-secondary"></i> [[topic:thread-tools.lock]]
		</a>
	</li>
	<li>
		<a component="topic/unlock" href="#" class="hidden dropdown-item d-flex align-items-center gap-2" role="menuitem">
	...
	<li>
		<a component="topic/move" href="#" class="dropdown-item d-flex align-items-center gap-2" role="menuitem">
			<i class="fa fa-fw fa-arrows text-secondary"></i> [[topic:thread-tools.move]]
		</a>
	</li>
	{{{if template.category}}}
	<li>
		<a component="topic/move-all" href="#" class="dropdown-item d-flex align-items-center gap-2" role="menuitem">
			<i class="fa fa-fw fa-arrows text-secondary"></i> [[topic:thread-tools.move-all]]
		</a>
	</li>
	{{{end}}}
	<li>
		<a component="topic/merge" href="#" class="dropdown-item d-flex align-items-center gap-2" role="menuitem">
			<i class="fa fa-fw fa-code-fork text-secondary"></i> [[topic:thread-tools.merge]]
		</a>
	</li>

	<li>
		<a component="topic/tag" href="#" class="dropdown-item d-flex align-items-center gap-2" role="menuitem">
	...
	<li>
		<a component="topic/delete" href="#" class="dropdown-item d-flex align-items-center gap-2" role="menuitem">
	...
	{{{each thread_tools}}}
	<li>
		<a href="#" class="dropdown-item d-flex align-items-center gap-2 {thread_tools.class}" role="menuitem">
